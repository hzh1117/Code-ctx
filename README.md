...
> **项目状态：** v1.1.2 修复了 npm 安装包的 Dashboard 生产启动流程；当前 `master` 已完成技术问题清单中的全部 P0-P3。初始化、增量更新、事实校验、隐私过滤、AI 请求控制和工程门禁已经过完整回归。
...
- Git（可选；运行时用于精确增量 diff，非 Git 项目会退回文件 hash 检测）
